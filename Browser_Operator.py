...
def test1():
    '''like not like test'''
    browser = Browser_operator("/home/michal/chromedriver")
    time.sleep(2)
    browser.like()
    time.sleep(2)
    browser.like()
    ...
    browser.not_like()
    time.sleep(2)
    browser.change_screen_mode()
    time.sleep(2)
    browser.increase_volume()
    browser.increase_volume()
    time.sleep(2)
    browser.like()
    time.sleep(2)
...
def test2():
    ...
    '''Moving by two and selecting video'''
    browser = Browser_operator("/home/michal/chromedriver")
    time.sleep(2)
    browser.increment_video_id_decision()
    time.sleep(2)
    browser.increment_video_id_decision()
    time.sleep(2)
    browser.change_video()
    time.sleep(2)

    '''Moving by three and selecting video'''
    time.sleep(2)
    browser.increment_video_id_decision()
    time.sleep(2)
    browser.increment_video_id_decision()
...
'''driver = webdriver.Chrome("/home/michal/chromedriver")
driver.get("https://www.youtube.com/watch?v=McnMsFwZlvA")
print(len(driver.find_elements_by_id("passwordNext")))'''
'''b = driver.find_element_by_id("movie_player")
b.click()
b.send_keys(Keys.UP)
a.send_keys("f")
time.sleep(2)
...
print(old_page)
time.sleep(4)
list = driver.find_elements_by_id("video-title")
print(len(list))
list[0].click()
